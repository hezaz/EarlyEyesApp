                ...
                <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                       <a class="dropdown-item text-info" href="{{url('admin/users/info/'.$user->id.'/tutor')}}">Info</a>
                        <a class="dropdown-item text-warning" href="{{url('admin/users/unblock/'.$user->id.'/tutor')}}">Unblock</a>
