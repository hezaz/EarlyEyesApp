           ...
           <tr>
                ...
                <td>
                    @foreach($user->children as $child)
                        @php
                            $childUrl = $child->userDetails->profile_pic != ''
                                ? $_ENV['APP_URL'].'public/images/user/'.$child->userDetails->profile_pic
                                : $_ENV['APP_URL'].'public/admin/dist/img/default-150x150.png';
                        @endphp
                        
                        <img src="{{$childUrl}}" alt="" class="img-circle img-size-32 mr-2"  style="width: 32px; height: 32px;">
                        {{ucwords($child->full_name)}}
                        <br>
                    @endforeach
                </td>
                 <td>
                ...
                <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                       <a class="dropdown-item text-info" href="{{url('admin/users/info/'.$user->id.'/parent')}}">Info</a>
                        <a class="dropdown-item text-warning" href="{{url('admin/users/unblock/'.$user->id.'/parent')}}">Unblock</a>
