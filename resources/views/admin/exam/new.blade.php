...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Add Sample Exam (Solve | Configure | Explain)</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card card-primary">
          ...
          @endif
          <form id="conf-exam-form" action="{{route('saveExam')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="session_question" class="form-control" id="session_question" rows="3" placeholder="Enter Exam Question">{{ old('session_question') }}</textarea>
                      </div>
                       <div class="form-group">
                        <label for="session_question_answer">Exam Question & Answer<span style="color: red;">*</span></label>
                        <textarea name="answer1" class="form-control" id="answer1" cols="6" rows="6" placeholder="Enter Exam Answer" data-sample-short>{{ old('answer1') }}</textarea>
                     </div>
                     <div class="form-group">
