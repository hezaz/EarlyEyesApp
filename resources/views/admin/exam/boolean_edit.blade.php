...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Edit Sample Exam (True | False)</h1>
      </div>
      <div class="col-sm-6">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="session_question_answer">Exam Question & Answer<span style="color: red;">*</span></label>
                         <input type="text" name="answer1" class="form-control" placeholder="1st possible Answer" value="True" readonly /><br/>
                        <input type="text" name="answer2" class="form-control" placeholder="2nd possible Answer" value="False" readonly /><br/>
                     </div>
                      <div class="form-group">
                        ...
                        <select name="correct_answer" class="form-control" id="correct_answer">
                          <option value="{{$exam->correct_answer}}">{{$exam->correct_answer}}</option>
