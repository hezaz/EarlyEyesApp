...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Edit Sample Exam (Multiple Choice)</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card card-primary">
          ...
          @endif
          <form id="multi-exam-form" action="{{route('updateExam')}}" method="post" enctype="multipart/form-data">
            @csrf
             <input type="hidden" name="id" value="{{$exam->id}}" />
            <input type="hidden" name="q_type" value="multiple" />
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="session_question" class="form-control" id="session_question" rows="3" placeholder="Enter Exam Question">{{ $exam->session_question }}</textarea>
                      </div>
                       <div class="form-group">
                        <label for="session_question_answer">Exam Question & Answer<span style="color: red;">*</span></label>
                         <input type="text" name="answer1" class="form-control" placeholder="1st possible Answer" value="{{$exam->answer1}}" /><br/>
                        <input type="text" name="answer2" class="form-control" placeholder="2nd possible Answer" value="{{$exam->answer2}}" /><br/>
                        <input type="text" name="answer3" class="form-control" placeholder="3rd possible Answer" value="{{$exam->answer3}}" /><br/>
                        <input type="text" name="answer4" class="form-control" placeholder="4th possible Answer" value="{{$exam->answer4}}" /><br/>
                        <input type="text" name="answer5" class="form-control" placeholder="5th possible Answer" value="{{$exam->answer5}}" />
                     </div>
                      <div class="form-group">
