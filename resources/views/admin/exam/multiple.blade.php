...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Add Sample Exam (Multiple Choice)</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card card-primary">
          ...
          @endif
          <form id="multi-exam-form" action="{{route('saveExam')}}" method="post" enctype="multipart/form-data">
            @csrf
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" name="answer1" class="form-control" placeholder="1st possible Answer" /><br/>
                        <input type="text" name="answer2" class="form-control" placeholder="2nd possible Answer" /><br/>
                        <input type="text" name="answer3" class="form-control" placeholder="3rd possible Answer" /><br/>
                        <input type="text" name="answer4" class="form-control" placeholder="4th possible Answer" /><br/>
                        <input type="text" name="answer5" class="form-control" placeholder="5th possible Answer" />
                     </div>
                      <div class="form-group">
                        <label for="correct_answer">Correct Answer<span style="color: red;">*</span></label>
                        <input type="text" name="correct_answer" class="form-control" id="correct_answer" placeholder="Enter Correct Answer" value="{{old('correct_answer')}}" />
                     </div> 
                  </div>
                <div class="col-md-6">
                      <div class="form-group">
