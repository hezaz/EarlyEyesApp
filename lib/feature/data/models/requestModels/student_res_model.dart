...
StudentResModel studentResModelFromJson(String str) => StudentResModel.fromJson(json.decode(str));

String studentResModelToJson(StudentResModel data) => json.encode(data.toJson());
...
class StudentResModel {
  ...
  factory StudentResModel.fromJson(Map<String, dynamic> json) => StudentResModel(
...
//     studentDetails: json["user_details"] == null ? null : StudentDetails.fromJson(json["user_details"]),
//   );
//
//   Map<String, dynamic> toJson() => {
//     "id": id,
...
//     "user_details": studentDetails?.toJson(),
//   };
// }
