...
//
//     final teacherSignupResModel = teacherSignupResModelFromJson(jsonString);
...
TeacherSignupResModel teacherSignupResModelFromJson(String str) => TeacherSignupResModel.fromJson(json.decode(str));

String teacherSignupResModelToJson(TeacherSignupResModel data) => json.encode(data.toJson());

class TeacherSignupResModel {
  final bool success;
  final String? message;
  final UserData? data;

  TeacherSignupResModel({
    required this.success,
    this.message,
    this.data,
  });

  factory TeacherSignupResModel.fromJson(Map<String, dynamic> json) => TeacherSignupResModel(
...
//   final TeacherDetails? userDetails;
//
//   UserData({
//     this.id,
//     this.roleId,
...
//     userDetails: json["user_details"] == null ? null : TeacherDetails.fromJson(json["user_details"]),
//   );
//
//   Map<String, dynamic> toJson() => {
//     "id": id,
