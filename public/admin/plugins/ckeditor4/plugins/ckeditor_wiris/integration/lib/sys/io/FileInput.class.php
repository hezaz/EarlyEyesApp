...
function sys_io_FileInput_0(&$ÂÂ»this, &$r) {
	throw new HException(haxe_io_Error::Custom("An error occurred"));
}
function sys_io_FileInput_1(&$ÂÂ»this, &$l, &$p, &$s) {
	throw new HException(new haxe_io_Eof());
}
function sys_io_FileInput_2(&$ÂÂ»this, &$l, &$p, &$r, &$s) {
	throw new HException(haxe_io_Error::Custom("An error occurred"));
}
function sys_io_FileInput_3(&$ÂÂ»this) {
	throw new HException(new haxe_io_Eof());
}
function sys_io_FileInput_4(&$ÂÂ»this, &$r) {
	throw new HException(haxe_io_Error::Custom("An error occurred"));
}
