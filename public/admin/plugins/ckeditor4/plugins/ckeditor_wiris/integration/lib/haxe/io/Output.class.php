...
function haxe_io_Output_0(&$ÂÂ»this, &$x) {
	{
...
function haxe_io_Output_1(&$ÂÂ»this, &$x) {
	{
...
function haxe_io_Output_2(&$ÂÂ»this, &$x) {
	{
...
function haxe_io_Output_3(&$ÂÂ»this, &$x) {
	{
		$x1 = $x & (255 | 0);
		if(($x1 >> 30 & 1) !== _hx_shift_right($x1, 31)) {
			throw new HException("Overflow " . Std::string($x1));
...
function haxe_io_Output_4(&$ÂÂ»this, &$x) {
	{
		$x1 = $x & (255 | 0);
		if(($x1 >> 30 & 1) !== _hx_shift_right($x1, 31)) {
			throw new HException("Overflow " . Std::string($x1));
...
function haxe_io_Output_5(&$ÂÂ»this, &$x) {
	{
		$x1 = _hx_shift_right($x, 8);
		if(($x1 >> 30 & 1) !== _hx_shift_right($x1, 31)) {
			throw new HException("Overflow " . Std::string($x1));
...
function haxe_io_Output_6(&$ÂÂ»this, &$x) {
	{
		$x1 = _hx_shift_right($x, 16);
		if(($x1 >> 30 & 1) !== _hx_shift_right($x1, 31)) {
			throw new HException("Overflow " . Std::string($x1));
...
function haxe_io_Output_7(&$ÂÂ»this, &$x) {
	{
		$x1 = _hx_shift_right($x, 24);
		if(($x1 >> 30 & 1) !== _hx_shift_right($x1, 31)) {
			throw new HException("Overflow " . Std::string($x1));
