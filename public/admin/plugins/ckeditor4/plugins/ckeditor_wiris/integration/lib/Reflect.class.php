...
class Reflect {
	...
	static function callMethod($o, $func, $args) {
		if(is_string($o) && !is_array($func)) {
			return call_user_func_array(Reflect::field($o, $func), $args->ÂÂ»a);
		}
		return call_user_func_array(((is_callable($func)) ? $func : array($o, $func)), ((null === $args) ? array() : $args->ÂÂ»a));
	}
	...
	static function deleteField($o, $f) {
		...
		if(isset($o->ÂÂ»dynamics[$f])) unset($o->ÂÂ»dynamics[$f]); else if($o instanceof _hx_anonymous) unset($o->$f); else $o->$f = null;
		return true;
	}
