...
function haxe_io_Input_0(&$ÂÂ»this, &$ch1, &$ch2, &$ch3, &$ch4) {
	if($ÂÂ»this->bigEndian) {
		return ($ch1 << 8 | $ch2) << 16 | ($ch3 << 8 | $ch4);
	} else {
		return ($ch4 << 8 | $ch3) << 16 | ($ch2 << 8 | $ch1);
	}
}
function haxe_io_Input_1(&$ÂÂ»this, &$ch1, &$ch2, &$ch3, &$ch4) {
	if($ÂÂ»this->bigEndian) {
...
function haxe_io_Input_2(&$ÂÂ»this, &$ch1, &$ch2, &$ch3) {
	if($ÂÂ»this->bigEndian) {
...
function haxe_io_Input_3(&$ÂÂ»this, &$ch1, &$ch2, &$ch3) {
	if($ÂÂ»this->bigEndian) {
		return $ch3 | $ch2 << 8 | $ch1 << 16;
	} else {
		return $ch1 | $ch2 << 8 | $ch3 << 16;
...
function haxe_io_Input_4(&$ÂÂ»this, &$ch1, &$ch2) {
	if($ÂÂ»this->bigEndian) {
		return $ch2 | $ch1 << 8;
	} else {
		return $ch1 | $ch2 << 8;
...
function haxe_io_Input_5(&$ÂÂ»this, &$ch1, &$ch2) {
	if($ÂÂ»this->bigEndian) {
		return $ch2 | $ch1 << 8;
	} else {
		return $ch1 | $ch2 << 8;
...
function haxe_io_Input_6(&$ÂÂ»this) {
